    ...
    <div className="max-w-2xl mx-auto space-y-6">
      ...
      {!isLoaded ? (
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 animate-fade-in-up">
          <StatCard value={matches.length} label="Partidos" />
          <StatCard value={finishedMatches.length} label="Finalizados" color="text-primary" />
          <StatCard value={totalPoints} label="Puntos jugados" color="text-secondary" />
          <StatCard value={formatDuration(totalTime) || '0m'} label="Tiempo total" color="text-accent" />
        </div>
      ) : null}

      {/* Win streak badge */}
      {finishedMatches.length > 0 && getWinStreak() > 1 && (
        <div className="flex items-center justify-center gap-2 py-2 animate-fade-in-up">
      ...
      <div className="grid grid-cols-3 sm:grid-cols-6 gap-3 animate-fade-in-up">
        ...
        <QuickLinkCard
          href="/entrenamiento"
          icon={<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="inline"><path d="m6.5 6.5 11 11" /><path d="m21 21-1-1" /><path d="m3 3 1 1" /><path d="m18 22 4-4" /><path d="m2 6 4-4" /><path d="m3 10 7-7" /><path d="m14 21 7-7" /></svg>}
          title="Entreno"
          description="Plan de entreno"
        />
        <QuickLinkCard
          href="/scouting"
          icon={<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="inline"><circle cx="11" cy="11" r="8" /><line x1="21" y1="21" x2="16.65" y2="16.65" /></svg>}
          title="Scouting"
          description="Informes rivales"
        />
        <QuickLinkCard
          href="/espectador"
          icon={<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="inline"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z" /><circle cx="12" cy="12" r="3" /></svg>}
          title="Espectador"
          description="Seguir en vivo"
        />
        <QuickLinkCard
          href="/estadisticas"
          icon={<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="inline"><line x1="18" y1="20" x2="18" y2="10" /><line x1="12" y1="20" x2="12" y2="4" /><line x1="6" y1="20" x2="6" y2="14" /></svg>}
          title="Stats"
          description="Dashboard global"
        />
        <QuickLinkCard
          href="/jugadores"
          icon={<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="inline"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2" /><circle cx="9" cy="7" r="4" /><path d="M23 21v-2a4 4 0 0 0-3-3.87" /><path d="M16 3.13a4 4 0 0 1 0 7.75" /></svg>}
          title="Jugadores"
          description="Perfiles y stats"
        />
      </div>
